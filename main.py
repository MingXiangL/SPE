...
from engine import evaluate_refinements, train_one_epoch_refine
...
def get_args_parser():
    ...
    parser.add_argument('--lr_cls_head', default=2e-5, type=float)
    ...
    parser.add_argument('--cam_thr', default=0.1, type=float, 
    ...
    parser.add_argument('--backbone_drop_rate', default=0.07, type=float)
    parser.add_argument('--drop_path_rate', default=0.2, type=float)
    parser.add_argument('--drop_block_rate', default=0., type=float)
    parser.add_argument('--drop_attn_rate', default=0.05, type=float)
    ...
    parser.add_argument('--layer_to_det', default=24, type=int, 
